...
function Collapse(props) {
  ...
  // Le second élément renvoyé est une fonction. Elle nous permet de modifier la variable isOpen, nous l’appellerons donc setOpen.
  return (
    <div className="collapsibles">
      <div className="collapsibles_container">
        ...
        <button
          // quand l’utilisateur clique, nous appelons setOpen, avec une nouvelle valeur TRUE. React rafraîchira le composant Collapse et lui passera la nouvelle valeur différente de l'ancienne.
