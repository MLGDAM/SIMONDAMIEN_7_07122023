    ...
    <div className="container1">
      ...
      {props.img.length > 1 && (
        <div className="container1_buttons">
          <img
            src={back} // attribut image chevron back
            onClick={prev} //on déclare l'événement à capter, et on lui passe entre accolades la fonction prev
            className="container1_buttons_icon1"
            alt="Preview icon"
          />

          <img
            src={next1} // attribut image chevron next
            onClick={next} //on déclare l'événement à capter, et on lui passe entre accolades la fonction next
            className="container1_buttons_icon2"
            alt="Next icon"
          />
        </div>
      )}
